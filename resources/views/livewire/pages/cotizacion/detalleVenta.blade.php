<div>
    <x-frk.components.template-crud maxWidth="2xl">
        <x-slot:title>
            <x-frk.components.title label="Cotizacion Completa" />
        </x-slot>
        <x-slot:body>
            <x-frk.components.label label="Datos de la cotizacion realizada:" />
            <div class="flex w-full mb-5">
                <div class="w-full md:w-1/2">
                    <x-frk.components.label-input   label="No Cotizacion:" wire:model="no_venta_detalle" disabled  />
                </div>
                <div class="w-full md:w-1/2">
                    <x-frk.components.label-input-money  label="Total Cotizacion:" wire:model="total_venta_detalle" disabled  />
                </div>
                <div class="w-full md:w-1/2">
        ...
        <x-slot:footer>
                ...
                <div class="flex w-full justify-center">
                    <a href="{{ route("pdfCotizacion",$no_venta_detalle) }}" target="_blank">
