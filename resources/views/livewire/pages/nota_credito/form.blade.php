<div class="flex w-full flex-wrap m-4">
    ...
    <div class="flex w-full ">
        ...
        <div class="flex w-full ">
            ...
            <div class="flex w-full md:w-1/4">
                <x-frk.components.label-input-money label="Saldo" :disabled="$disabled" wire:model.live="saldo_credito" />
            </div>
        </div>
            <x-frk.components.divisor-line />
        ...
        <div class="flex w-full ">
            <div class=" w-full md:w-2/4">
                <div class="flex w-full md:w-3/4" x-data="{open: @entangle('anulado')}"  >
                    <x-frk.components.toggle :disabled="$disabled" wire:click="anulacionVenta()" label="Anulacion Venta" left="No" right="Si"   />
                </div>
            </div>

            <div class="flex w-full md:w-1/4">
                <x-frk.components.label-input-money  label="Cantidad Nota Credito:" error="cantidad_nota_credito"  wire:model.live="cantidad_nota_credito" />
            </div>
            <div class="flex w-full md:w-1/4">
