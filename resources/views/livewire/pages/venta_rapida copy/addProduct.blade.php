        ...
        <div class="flex flex-wrap">
            <div class="flex w-full">
                ...
                <div class="flex  flex-wrap w-2/6">
                    ...
                    @if($isPie)
                        <x-frk.components.label-input-money label="Precio Pie:"  wire:model.live="precio_unitario" />
                    @endif
                    <x-frk.components.label-input-moneyy label="Precio Final:"  wire:model.live="precio_final" @blur=" let v = parseFloat($event.target.value || 0); $event.target.value = v.toFixed(2);" />
                </div>
            </div>
            ...
            <div class="flex w-full">
                ...
                <div class="flex flex-wrap w-2/6">
                        ...
                        <x-frk.components.label-input-moneyy label="Subtotal:" error="subtotal_producto"  :disabled="$disabled_subtotal_producto" wire:model.live="subtotal_producto" @blur=" let v = parseFloat($event.target.value || 0); $event.target.value = v.toFixed(2);" />
