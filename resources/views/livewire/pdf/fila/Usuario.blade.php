   ...
   <table style="width:100%; border-collapse:collapse;">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align:left;">
                {{ \Carbon\Carbon::parse($data->fecha_nacimiento)->format('d/m/Y') }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align:left;">
                {{ $data->tipo_sangre ?: 'No registrado' }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align:left;">
                {{ \Carbon\Carbon::parse($data->inicio_labores)->format('d/m/Y') }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align:left;">
                @if($data->fin_labores)
                    {{ \Carbon\Carbon::parse($data->fin_labores)->format('d/m/Y') }}
                @else
