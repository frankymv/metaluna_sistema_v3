...
<table style="width:100%; border-collapse:collapse;">
    ...
    <thead>
        <tr class="titulo-seccion">
            <th colspan="2">Registro de Combustible</th>
        </tr>
    </thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="text-align:left;">
                {{ \Carbon\Carbon::parse($data->fecha_combustible)->format('d/m/Y H:i') }}
            </td>
        </tr>
        ...
        <tr>
            ...
            <td style="text-align:left;">
                Q {{ number_format($data->total_combustible, 2) }}
            </td>
        </tr>
        <tr>
            <td class="gris" style="text-align:left;">
