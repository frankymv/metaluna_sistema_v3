...
class ProveedorController extends Component
{
    ...
    public $id_last,$nombre,$departamento,$municipio, $descripcion, $nit, $nombre_representante, $telefono_principal, $telefono_secundario, $direccion_fisica, $direccion_departamento, $direccion_municipio, $correo_electronico,$estado='Activo';
    ...
    {
        $data_temp=Proveedor::where('nombre','LIkE',"%{$this->filtroNombre}%")
    ...
    {
        $marca=Proveedor::find($rowId);
         $data=exportarFilaPDF('Proveedor', [
            'data' => $marca,
        ]);
        return $data;
    }
    ...
    public function cancel(){
        $this->dispatch('pg:eventRefresh-proveedor-table-ofztyj-table');
        $this->reset();
