...
class VehiculoController extends Component
{
    ...
    public $filtroCodigo=null;
    public $filtroNumeroPlaca=null;
    public $filtroAlias=null;





    public $tipos=null,$placas=null,$marcas=null,$modelos=null, $estado='Activo';
    ...
    {
        $data_temp=Vehiculo::find($rowId);
         $data=exportarFilaPDF('Vehiculo', [
            'data' => $data_temp,
        ]);
        return $data;
    }
    ...
    public function cancel(){
        $this->dispatch('pg:eventRefresh-vehiculoTable');
