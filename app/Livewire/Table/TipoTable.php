...
final class TipoTable extends PowerGridComponent
{
    public string $tableName = 'tipo-table-qkz3kr-table';
   ...
   ////////////////////////////////////////////////////////////////////////////////////
    ...
    // Ordenamiento
        ...
        $datas = $query->get();
        return exportarGeneralPDF('Tipo', [
            'data' => $datas,
        ]);
    }
    ...
    public function actions(Tipo $row): array
    {
        return [
            Button::add('edit')
                ->icon('default-edit')
